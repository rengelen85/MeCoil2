...
var __vite_injected_original_import_meta_url = "file:///C:/Users/tamar/Code%20repos/MeCoil/client/vite.config.js";
...
var vite_config_default = defineConfig({
  ...
  server: {
    host: true,
    https: hasCerts ? { cert: fs.readFileSync(CERT_PATH), key: fs.readFileSync(KEY_PATH) } : false,
    proxy: {
      "/ws": {
        target: wsTarget,
        ws: true,
